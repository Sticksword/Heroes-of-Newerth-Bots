...
behaviorLib.StartingItems  = { "Item_RunesOfTheBlight", "Item_MinorTotem", "Item_MinorTotem", "Item_PretendersCrown", "Item_ManaPotion"}
behaviorLib.LaneItems  = {"Item_Marchers","Item_Steamboots","Item_GraveLocket"}
behaviorLib.MidItems  = {"Item_PushStaff","Item_Morph","Item_PortalKey"}
behaviorLib.LateItems  = {"Item_FrostfieldPlate","Item_GrimoireOfPower"}
-- Item_Bottle, Item_BoundEye, Item_Protect
